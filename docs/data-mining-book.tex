...
\NormalTok{  Vh <-}\StringTok{ }\KeywordTok{matrix}\NormalTok{(}\OtherTok{NA}\NormalTok{, }\DataTypeTok{nrow =}\NormalTok{ r, }\DataTypeTok{ncol =}\NormalTok{ r)}
  ...
  \ControlFlowTok{for}\NormalTok{ (h }\ControlFlowTok{in} \KeywordTok{seq_len}\NormalTok{(r)) \{}
    \CommentTok{# 단계 1}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pca_fit <-}\StringTok{ }\KeywordTok{prcomp}\NormalTok{(train_df[, }\KeywordTok{c}\NormalTok{(}\StringTok{"x1"}\NormalTok{, }\StringTok{"x2"}\NormalTok{, }\StringTok{"x3"}\NormalTok{)], }\DataTypeTok{rank. =} \DecValTok{2}\NormalTok{,}
                  \DataTypeTok{center =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{scale. =} \OtherTok{FALSE}\NormalTok{)}
\NormalTok{pca_fit}\OperatorTok{$}\NormalTok{x}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y_centered <-}\StringTok{ }\NormalTok{train_df}\OperatorTok{$}\NormalTok{y }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(train_df}\OperatorTok{$}\NormalTok{y)}
\NormalTok{y_centered}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pc_lm_fit <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(y_centered }\OperatorTok{~}\StringTok{ }\OperatorTok{-}\StringTok{ }\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{pca_fit}\OperatorTok{$}\NormalTok{x)}
\KeywordTok{coef}\NormalTok{(pc_lm_fit)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pca_fit}\OperatorTok{$}\NormalTok{rotation}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{beta_x <-}\StringTok{ }\NormalTok{pca_fit}\OperatorTok{$}\NormalTok{rotation }\OperatorTok{%*%}\StringTok{ }\KeywordTok{coef}\NormalTok{(pc_lm_fit)}
\NormalTok{beta_x}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(train_df}\OperatorTok{$}\NormalTok{y) }\OperatorTok{-}\StringTok{ }\KeywordTok{colMeans}\NormalTok{(train_df[, }\KeywordTok{c}\NormalTok{(}\StringTok{"x1"}\NormalTok{, }\StringTok{"x2"}\NormalTok{, }\StringTok{"x3"}\NormalTok{)]) }\OperatorTok{%*%}\StringTok{ }\NormalTok{beta_x}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nipals_plsr <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(X, y, }\DataTypeTok{A =} \OtherTok{NULL}\NormalTok{) \{}
...
\NormalTok{  b <-}\StringTok{ }\KeywordTok{vector}\NormalTok{(}\StringTok{"numeric"}\NormalTok{, }\DataTypeTok{length =}\NormalTok{ A)}
  
  \ControlFlowTok{for}\NormalTok{ (a }\ControlFlowTok{in} \KeywordTok{seq_len}\NormalTok{(A)) \{}
    \CommentTok{# 단계 1}
\NormalTok{    Wmat[, a] <-}\StringTok{ }\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(X }\OperatorTok{~}\StringTok{ }\DecValTok{-1} \OperatorTok{+}\StringTok{ }\NormalTok{y))}
    
    \CommentTok{# 단계 2}
\NormalTok{    Wmat[, a] <-}\StringTok{ }\NormalTok{Wmat[, a] }\OperatorTok{/}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{sum}\NormalTok{(Wmat[, a] }\OperatorTok{^}\StringTok{ }\DecValTok{2}\NormalTok{))}

    \CommentTok{# 단계 3}
\NormalTok{    Tmat[, a] <-}\StringTok{ }\NormalTok{X }\OperatorTok{%*%}\StringTok{ }\NormalTok{Wmat[, a]}
    
    \CommentTok{# 단계 4}
\NormalTok{    Pmat[, a] <-}\StringTok{ }\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(X }\OperatorTok{~}\StringTok{ }\DecValTok{-1} \OperatorTok{+}\StringTok{ }\NormalTok{Tmat[, a]))}
    
    \CommentTok{# 단계 5}
\NormalTok{    p_size <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{sum}\NormalTok{(Pmat[, a] }\OperatorTok{^}\StringTok{ }\DecValTok{2}\NormalTok{))}
\NormalTok{    Tmat[, a] <-}\StringTok{ }\NormalTok{Tmat[, a] }\OperatorTok{*}\StringTok{ }\NormalTok{p_size}
\NormalTok{    Wmat[, a] <-}\StringTok{ }\NormalTok{Wmat[, a] }\OperatorTok{*}\StringTok{ }\NormalTok{p_size}
\NormalTok{    Pmat[, a] <-}\StringTok{ }\NormalTok{Pmat[, a] }\OperatorTok{/}\StringTok{ }\NormalTok{p_size}
    
    \CommentTok{# 단계 6}
\NormalTok{    b[a] <-}\StringTok{ }\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(y }\OperatorTok{~}\StringTok{ }\DecValTok{-1} \OperatorTok{+}\StringTok{ }\NormalTok{Tmat[, a]))}
...
\NormalTok{    y <-}\StringTok{ }\NormalTok{y }\OperatorTok{-}\StringTok{ }\NormalTok{Tmat[, a] }\OperatorTok{%*%}\StringTok{ }\KeywordTok{t}\NormalTok{(b[a])}
\NormalTok{  \}}
  
  \KeywordTok{return}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{T =}\NormalTok{ Tmat, }\DataTypeTok{W =}\NormalTok{ Wmat, }\DataTypeTok{P =}\NormalTok{ Pmat, }\DataTypeTok{b =}\NormalTok{ b))}
\NormalTok{\}}

\NormalTok{X <-}\StringTok{ }\KeywordTok{as.matrix}\NormalTok{(train_df[, }\KeywordTok{c}\NormalTok{(}\StringTok{"x1"}\NormalTok{, }\StringTok{"x2"}\NormalTok{, }\StringTok{"x3"}\NormalTok{)])}
\NormalTok{y <-}\StringTok{ }\NormalTok{train_df}\OperatorTok{$}\NormalTok{y}
\NormalTok{nipals_fit <-}\StringTok{ }\KeywordTok{nipals_plsr}\NormalTok{(X, y, }\DataTypeTok{A =} \DecValTok{2}\NormalTok{)}
\NormalTok{nipals_fit}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{P_hat <-}\StringTok{ }\KeywordTok{t}\NormalTok{(}\KeywordTok{solve}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }\NormalTok{X)}
\KeywordTok{all}\NormalTok{(}\KeywordTok{near}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{P, P_hat))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{b_hat <-}\StringTok{ }\KeywordTok{as.vector}\NormalTok{(}\KeywordTok{t}\NormalTok{(}\KeywordTok{solve}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }
\StringTok{                       }\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }\KeywordTok{as.matrix}\NormalTok{(y, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{)))}
\KeywordTok{all}\NormalTok{(}\KeywordTok{near}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{b, b_hat))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{beta_pls <-}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{W }\OperatorTok{%*%}\StringTok{ }
\StringTok{  }\KeywordTok{solve}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{P) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{W) }\OperatorTok{%*%}
\StringTok{  }\KeywordTok{as.matrix}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{b, }\DataTypeTok{ncol =}\NormalTok{ 1L)}
\NormalTok{beta_pls}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SSR_a <-}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{b }\OperatorTok{^}\StringTok{ }\DecValTok{2} \OperatorTok{*}\StringTok{ }\KeywordTok{diag}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{T)}
\NormalTok{SSR_a}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{diag}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\KeywordTok{diag}\NormalTok{(}\KeywordTok{t}\NormalTok{(X) }\OperatorTok{%*%}\StringTok{ }\NormalTok{X))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{(}\KeywordTok{diag}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{T) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{T)) }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\KeywordTok{diag}\NormalTok{(}\KeywordTok{t}\NormalTok{(X) }\OperatorTok{%*%}\StringTok{ }\NormalTok{X))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Wx <-}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{W }\OperatorTok{%*%}\StringTok{ }\KeywordTok{solve}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{P) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{W)}
\NormalTok{VIP <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}
  \KeywordTok{colSums}\NormalTok{(}
\NormalTok{    k }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(SSR_a) }\OperatorTok{*}\StringTok{ }\NormalTok{SSR_a }\OperatorTok{*}\StringTok{ }
\StringTok{      }\NormalTok{(}\KeywordTok{t}\NormalTok{(Wx }\OperatorTok{^}\StringTok{ }\DecValTok{2}\NormalTok{) }\OperatorTok{/}\KeywordTok{diag}\NormalTok{(}\KeywordTok{t}\NormalTok{(Wx) }\OperatorTok{%*%}\StringTok{ }\NormalTok{Wx))}
\NormalTok{    )}
\NormalTok{  )}
\NormalTok{VIP}
\end{Highlighting}
...
\NormalTok{      Tmat[, a] <-}\StringTok{ }\NormalTok{X }\OperatorTok{%*%}\StringTok{ }\NormalTok{Wmat[, a]}
      ...
      \CommentTok{# 단계 5}
\NormalTok{      Qmat[, a] <-}\StringTok{ }\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Y }\OperatorTok{~}\StringTok{ }\DecValTok{-1} \OperatorTok{+}\StringTok{ }\NormalTok{Tmat[, a]))}
      
      \CommentTok{# 단계 6}
\NormalTok{      Qmat[, a] <-}\StringTok{ }\NormalTok{Qmat[, a] }\OperatorTok{/}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{sum}\NormalTok{(Qmat[, a] }\OperatorTok{^}\StringTok{ }\DecValTok{2}\NormalTok{))}
      
      \CommentTok{# 단계 7}
\NormalTok{      u_new <-}\StringTok{ }\NormalTok{Y }\OperatorTok{%*%}\StringTok{ }\NormalTok{Qmat[, a]}
      
      \CommentTok{# 단계 8}
      \ControlFlowTok{if}\NormalTok{ (}\KeywordTok{all}\NormalTok{(}\KeywordTok{near}\NormalTok{(u_new, Umat[, a]))) }\ControlFlowTok{break}
      
\NormalTok{      Umat[, a] <-}\StringTok{ }\NormalTok{u_new}
\NormalTok{    \}}
...
\NormalTok{    Pmat[, a] <-}\StringTok{ }\NormalTok{Pmat[, a] }\OperatorTok{/}\StringTok{ }\NormalTok{p_size}
    ...
    \CommentTok{# 단계 11}
\NormalTok{    Bmat[a, a] <-}\StringTok{ }\KeywordTok{coef}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Umat[, a] }\OperatorTok{~}\StringTok{ }\DecValTok{-1} \OperatorTok{+}\StringTok{ }\NormalTok{Tmat[, a]))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{beta_pls2 <-}\StringTok{ }\NormalTok{nipals_fit2}\OperatorTok{$}\NormalTok{W }\OperatorTok{%*%}\StringTok{ }
\StringTok{  }\KeywordTok{solve}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit2}\OperatorTok{$}\NormalTok{P) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit2}\OperatorTok{$}\NormalTok{W) }\OperatorTok{%*%}\StringTok{ }
\StringTok{  }\NormalTok{nipals_fit2}\OperatorTok{$}\NormalTok{B }\OperatorTok{%*%}\StringTok{ }\KeywordTok{t}\NormalTok{(nipals_fit2}\OperatorTok{$}\NormalTok{Q)}
\NormalTok{beta_pls2}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SSR_a <-}\StringTok{ }\KeywordTok{diag}\NormalTok{(}
  \KeywordTok{t}\NormalTok{(nipals_fit2}\OperatorTok{$}\NormalTok{T }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit2}\OperatorTok{$}\NormalTok{B) }\OperatorTok{%*%}\StringTok{ }
\StringTok{    }\NormalTok{(nipals_fit2}\OperatorTok{$}\NormalTok{T }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit2}\OperatorTok{$}\NormalTok{B)}
\NormalTok{)}
\NormalTok{SSR_a}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SSR_aj <-}\StringTok{ }\KeywordTok{diag}\NormalTok{(SSR_a) }\OperatorTok{%*%}\StringTok{ }\KeywordTok{t}\NormalTok{(nipals_fit2}\OperatorTok{$}\NormalTok{Q }\OperatorTok{^}\StringTok{ }\DecValTok{2}\NormalTok{)}
\NormalTok{SSR_aj}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SS_j <-}\StringTok{ }\KeywordTok{colSums}\NormalTok{(Y }\OperatorTok{^}\StringTok{ }\DecValTok{2}\NormalTok{)}
\NormalTok{SSR_aj }\OperatorTok{%*%}\StringTok{ }\KeywordTok{diag}\NormalTok{(}\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{SS_j)}
\end{Highlighting}
\end{Shaded}
