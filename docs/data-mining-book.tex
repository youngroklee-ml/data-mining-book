...
\StringTok{      }\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{W }\OperatorTok{^}\StringTok{ }\DecValTok{2}\NormalTok{) }\OperatorTok{/}\StringTok{ }
\StringTok{         }\KeywordTok{diag}\NormalTok{(}\KeywordTok{t}\NormalTok{(nipals_fit}\OperatorTok{$}\NormalTok{W) }\OperatorTok{%*%}\StringTok{ }\NormalTok{nipals_fit}\OperatorTok{$}\NormalTok{W))}
\NormalTok{    )}
\NormalTok{  )}
\NormalTok{VIP}
\end{Highlighting}
